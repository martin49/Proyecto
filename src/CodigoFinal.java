            ...
            bw.append("move $fp,$sp\n");
             ...
             for (int i = 0; i < TablaIntermedio.tabla.size(); i++) {
                 switch(TablaIntermedio.tabla.get(i).operador){
                     ...
                     case "+":{
                         if(i==0){
                             if(TablaSimbolos.isinteger(TablaIntermedio.tabla.get(i).getArg1())){
                                 ...
                                 bw.append("add $"+TablaIntermedio.tabla.get(i).resultado+", $"+TablaIntermedio.tabla.get(i).arg1+", "+TablaIntermedio.tabla.get(i).arg1+"\n");
                             }
                         }else{
                             if(TablaSimbolos.isinteger(TablaIntermedio.tabla.get(i).getArg1())){
                                 bw.append("li $a0,"+TablaIntermedio.tabla.get(i).arg1+"\n");
                     ...
                     case "-":{
                         if(i==0){
                             if(TablaSimbolos.isinteger(TablaIntermedio.tabla.get(i).getArg1())){
                                 ...
                                 bw.append("sub $"+TablaIntermedio.tabla.get(i).resultado+", $"+TablaIntermedio.tabla.get(i).arg1+", "+TablaIntermedio.tabla.get(i).arg1+"\n");
                             }
                         }else{
                             if(TablaSimbolos.isinteger(TablaIntermedio.tabla.get(i).getArg1())){
                                 bw.append("li $a0,"+TablaIntermedio.tabla.get(i).arg1+"\n");
                     ...
                     case "*":{
                         if(i==0){
                             if(TablaSimbolos.isinteger(TablaIntermedio.tabla.get(i).getArg1())){
                                 ...
                                 bw.append("mul $"+TablaIntermedio.tabla.get(i).resultado+", $"+TablaIntermedio.tabla.get(i).arg1+", "+TablaIntermedio.tabla.get(i).arg1+"\n");
                             }
                         }else{
                             if(TablaSimbolos.isinteger(TablaIntermedio.tabla.get(i).getArg1())){
                                 bw.append("li $a0,"+TablaIntermedio.tabla.get(i).arg1+"\n");
                         ...
                         if(i==0){
                             if(TablaSimbolos.isinteger(TablaIntermedio.tabla.get(i).getArg1())){
                                 ...
                                 bw.append("div $"+TablaIntermedio.tabla.get(i).resultado+", $"+TablaIntermedio.tabla.get(i).arg1+", "+TablaIntermedio.tabla.get(i).arg1+"\n");
                             }
                         }else{
                             if(TablaSimbolos.isinteger(TablaIntermedio.tabla.get(i).getArg1())){
                                 bw.append("li $a0,"+TablaIntermedio.tabla.get(i).arg1+"\n");
